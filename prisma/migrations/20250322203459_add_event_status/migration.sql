...
INSERT INTO "new_Event" ("clubId", "createdAt", "date", "description", "id", "location", "maxParticipants", "name", "time", "updatedAt") SELECT "clubId", "createdAt", "date", "description", "id", "location", "maxParticipants", "name", "time", "updatedAt" FROM "Event";
DROP TABLE "Event";
